    ...
    <Grid container direction='column' className={classes.mainContainer}>
      <Head>
        ...
        <meta
          name='description'
          key='description'
          content='Pristine software custom-designed from the group up with cutting-edge optimizations. Use our free estimate calculator to check your project cost!'
        />
        <meta
          property='og:title'
